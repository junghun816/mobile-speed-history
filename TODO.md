...
- [x] 기록 목록에서 런닝 기록 구분 표시 — 카드 헤더에 🚲/🏃 아이콘 추가
- [ ] 기록 상세 랩 테이블 UI 확인 (코드는 구현됨)
- [x] 런닝 기록 평균 페이스·최고 페이스 통계 표시 — 카드 및 상세 팝업 모두 속도→페이스 전환
...
- [x] 캘린더 히트맵 — 기록 탭 '히트맵' 탭 신규 추가. 연간 GitHub 잔디 스타일 커스텀 그리드, 연도 선택·날짜 탭 지원
